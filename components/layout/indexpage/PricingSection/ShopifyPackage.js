  ...
  return (
    ...
    <div className='row pricing-main justify-content-center'>
      ...
      <div className='pack'>
        ...
        <div className='head'>
        <h3>Starter<br/>Shopify Package</h3>
        </div>
        <h2>
        <sup>$</sup>
        599
        ...
        <ul>
          <li>Custom design homepage(1x concepts)</li>   
          <li>5 custom designed inner pages</li>   
          <li>Upto 25-50 products</li>   
        ...
        <p className='pkg-addOn'>Add On <span>$50 </span>for expedited services</p>
      </div>
        <a>Start Project</a>
      </div>
      </div>
